export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxca46b225c545e84c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "16908548effd5cd9cd73733b9c55ac2c",
  ...
  USERS: [
    {
      ...
      id: "ooxw26H2xh9ujfIXDc5_Z0vs7U4s","ooxw26LZlcWcO9qxsbORMmx4o1cI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "LEjF9fTvEus9yPgVyeSttg-JbWNMr8U0CmyaqcGMhco",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ooxw26H2xh9ujfIXDc5_Z0vs7U4s",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
